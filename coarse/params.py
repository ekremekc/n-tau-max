...
a_f = 0.025*scaler  # default:0.025[m]
...
# if reducer 0.2 ->  mesh size is [144, 120]
...
tt = ndimage.interpolation.zoom(tt,reducer) #decimate resolution
nn = ndimage.interpolation.zoom(nn,reducer) #decimate resolution
